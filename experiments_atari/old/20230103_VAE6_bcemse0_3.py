...
cfg = {
    ...
    'mu_var_loss': True,
    # One per each DMs
    'loss_functions' : [VAELossBCE_MSE(), VAELossBCE_MSE(), VAELossBCE_MSE(), VAELossBCE_MSE(), VAELossBCE_MSE(), VAELossBCE_MSE(), VAELossBCE_MSE(), VAELossBCE_MSE(), VAELossBCE_MSE(), VAELossBCE_MSE()],
    # One per each DMs
