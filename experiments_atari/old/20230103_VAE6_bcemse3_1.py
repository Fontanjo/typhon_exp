...
cfg = {
    ...
    'lrates' : {
        # One per each DMs
        'train' : [5e-5, 5e-5, 5e-5, 5e-5, 5e-5, 5e-5, 5e-5, 5e-5, 5e-5,5e-5],
    ...
    'mu_var_loss': True,
    # One per each DMs
    'loss_functions' : [VAELossBCE_MSE(weights=[1,1000,1]), VAELossBCE_MSE(weights=[1,1000,1]), VAELossBCE_MSE(weights=[1,1000,1]), VAELossBCE_MSE(weights=[1,1000,1]), VAELossBCE_MSE(weights=[1,1000,1]), VAELossBCE_MSE(weights=[1,1000,1]), VAELossBCE_MSE(weights=[1,1000,1]), VAELossBCE_MSE(weights=[1,1000,1]), VAELossBCE_MSE(weights=[1,1000,1]), VAELossBCE_MSE(weights=[1,1000,1])],
    # One per each DMs
