...
cfg = {
    ...
    'mu_var_loss': True,
    # One per each DMs
    'loss_functions' : [VAELossBCE_MSE(weights=[1,100,1]), VAELossBCE_MSE(weights=[1,100,1]), VAELossBCE_MSE(weights=[1,100,1]), VAELossBCE_MSE(weights=[1,100,1]), VAELossBCE_MSE(weights=[1,100,1]), VAELossBCE_MSE(weights=[1,100,1]), VAELossBCE_MSE(weights=[1,100,1]), VAELossBCE_MSE(weights=[1,100,1]), VAELossBCE_MSE(weights=[1,100,1]), VAELossBCE_MSE(weights=[1,100,1])],
    # One per each DMs
