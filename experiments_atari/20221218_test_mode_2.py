...
import utils
from utils import VAELoss, VAELossBCE
...
cfg = {
    ...
    # Datasets
    'dsets' : ['FishingDerby-v5', 'DemonAttack-v5', 'Frostbite-v5', 'Kangaroo-v5', 'NameThisGame-v5', 'Phoenix-v5', 'Qbert-v5', 'Seaquest-v5', 'SpaceInvaders-v5', 'TimePilot-v5'],
    'trg_dset' : 'FishingDerby-v5',
    ...
    'lrates' : {
        # One per each DMs
        'train' : [1e-4, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3],
    ...
    'mu_var_loss': True,
    # One per each DMs
    'loss_functions' : [VAELossBCE(), VAELossBCE(), VAELossBCE(), VAELossBCE(), VAELossBCE(), VAELossBCE(), VAELossBCE(), VAELossBCE(), VAELossBCE(), VAELossBCE()],
    # One per each DMs
