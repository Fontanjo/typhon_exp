...
cfg = {
    ...
    'mu_var_loss': False,
    # One per each DMs
    'loss_functions' : [torch.nn.BCELoss(), torch.nn.BCELoss(), torch.nn.BCELoss(), torch.nn.BCELoss(), torch.nn.BCELoss(), torch.nn.BCELoss(), torch.nn.BCELoss(), torch.nn.BCELoss(), torch.nn.BCELoss(), torch.nn.BCELoss()],
    # One per each DMs
