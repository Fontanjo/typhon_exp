...
import copy
import time
from utils import VAELossMSE, VAELossBCE, VAELossBCE_MSE, EqualPixels2, EqualPixelsBCE
...
cfg = {
    ...
    'epochs' : {
        ...
        'train' : 96000, # Same as baseline, considering batch_per_epoch and batch sizes
        'spec' : 0,
    },
    'architecture' : 'paper_segmentation_v3_pretrained', # Pass only top 32, to force learning bigger sprites
