...
class PixelPerfect(torch.nn.Module):
    def __init__(self, n_features=128, k_vals=3):
        ...
        self.mp0 = torch.nn.MaxPool3d(kernel_size=(self.k_vals, 1, 1), stride=1, dilation=1, return_indices=True, ceil_mode=True) # ~64x64x3
...
class AE(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        x = PixelPerfect(n_features=NB_FEATURES, k_vals=K_VALS)(x)
